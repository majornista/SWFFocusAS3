package net.majordan.controls
{
	...
	import net.majordan.accessibility.MAJLinkButtonAccImpl;
	...
	public class  AccLinkButton extends Sprite
	{
		...
		private function configUI():void
		{
			...
			_styleSheet.setStyle("a", { fontFamily:"_sans", fontSize:"16" } );
			...
			if (DisplayObjectContainer(this).numChildren==2) {
				...
				_bg_mc = new Sprite();
				_bg_mc.graphics.beginFill(0xffffff, 0);
				_bg_mc.graphics.drawRect(0, 0, 1, 1);
			...
			MAJLinkButtonAccImpl.createAccessibilityImplementation(this as InteractiveObject);
		}
